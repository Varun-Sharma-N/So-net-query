...
<div id="content">
    ...
    <div class="row_1">
        <div class="container">
      <div class="skk"> <font size="+4px;" color="green"><marquee> SUCCESSFULLY-UPLODED </marquee></font> </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-5 col-sm-5 row3col1">
                    <div class="box1 clearfix">
                     ...
                     <img src="img/animated-success-image-0015.gif" alt="" style="margin-left: 100px; width: 650px; height:300px; border: 5px solid black;">
                      </div>                    
                     </div>
