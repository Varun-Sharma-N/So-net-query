...
<div id="content">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-5 col-sm-5 row3col1">
                                    <div class="shak11" style= "margin-left: 280px; width: 700px;">
  ...
  String ques = (String) session.getAttribute("s2");
  System.out.print("question"+ques);
   try
               {
               	DBCollection coll1 = null;
               	MongoClient mongoClient1 = new MongoClient("127.0.0.1",27017);
               	DB db = mongoClient1.getDB("socialqsandans");
               	coll1 = db.getCollection("answer");
               	BasicDBObject wheresearch = new BasicDBObject();
               	wheresearch.put("question",ques);
               	DBCursor cursor1 = coll1.find(wheresearch);
