...
<head>
      ...
      
	{
		...
		var a1 = document.f.admin.value;
		if(a1=="")
			{
	    alert("please enter the admin");
	    document.f.admin.focus();
		return false;
		}
		{
    ...
    <div class="row_1">
        <div class="container">
            <div class="row">
                ...
                <div class="shak" style=" width: 350px;">
                <img src="img/Admin-Login (1).gif" alt="" width="330px;" height="200px;" style="margin-top: 40px;"> 
                  </div>
                </div>
                <div class="col-lg-4 col-md-5 col-sm-5 row3col1">
                
                                    <div class="shak11" style= "margin-left: 100px; width: 700px;  margin-top: 30px;">
                        <form action="admindb.jsp" name="f" method="get" onsubmit= "return validation()">
			<table>
			<th><font style="font: italic small-caps bold 25px Georgia;color:#ffda42;">Admin-Login: </font> </th>
			<tr>
			...
			<td> <input id="text1" type="text" class="tex1" name="admin"  placeholder="enter username"/> <br></br> </td>
			</tr>
			...
			<td> <input id="text1" type="password" class="tex1" name="pass"  placeholder="enter the password"/> <br></br></td>
			</tr>
