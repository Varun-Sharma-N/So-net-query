...
ArrayList list = new ArrayList();
	    ...
	    String a1=null,image=null;String b=null;String c=null;String e=null; String f1=null;String g=null;String h=null;String i=null;String j=null;String n=null;String p=null;String q=null,l=null,m=null,n1=null,n2=null;
	...
	try {
			...
			while (params.hasMoreElements()) 
			{
				...
				if(paramname.equalsIgnoreCase("qname"))
				{
	...
	while (files.hasMoreElements()) 
	{
    	...
    	DBCollection collection = db.getCollection("answer");
        BasicDBObject wherequery1 = new BasicDBObject("question", a1).append("reply", b).append("work",c).append("quename",d).append("image",datafile);
