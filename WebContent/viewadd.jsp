    ...
    <div class="row_1">
        <div class="container">
            <div class="row">
             ...
             <font size="+4px;" color="#000000;"><center> ADMIN-HERE: </center></font>   
         
          <font size="+2px;" color="red"> VIEW-PROFESSIONAL:</font> 
          <table>
          <%
try
{
...
while(cursor.hasNext())
{
	...
	<tr><td><font color="red" size="+3px;"><%=object.get("id")%></font></td>
	<td> <font color="red" size="+3px;"><%=object.get("professional")%></font></td>
	
	 <td><font size="+3px;"> <a href="update.jsp?ss=<%=object.get("id") %>">Update</a></font></td>
	</font>
...
<img src="img/display-Last-Updated-Date-of-Posts-image.gif" alt="" style="margin-left: 400px; margin-top: -500px;">
                      </div>
                    </div>                   
                </div>
            </div>
