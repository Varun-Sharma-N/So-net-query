    ...
    <div class="row_1">
        <div class="container">
            <div class="row">
                ...
                <img src="img/questions-1014060_960_720.jpg" alt=""> 
                  </div>
                </div>
...
String work=session.getAttribute("worklist").toString()+",";
int flag=0;
try
{
	DBCollection coll1 = null;
   	...
   	coll1 = db1.getCollection("ques");
   	BasicDBObject wheresearch1 = new BasicDBObject();
   	wheresearch1.put("sendto",work);
   	DBCursor cursor1 = coll1.find(wheresearch1);
   if(cursor1.hasNext())
   {
	   flag=0;
   }
...
try                           
{
   ...
   <td> 
 <td> <a href="reply.jsp?sss=<%=object.get("id") %>">Reply</a></td>
  </tr>
</table>
	 <%
...
{
	response.sendRedirect("search.jsp?msg1=nowrites");
	}
